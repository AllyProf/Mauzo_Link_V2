...
<head>
    <meta charset="utf-8">
    <title>Register - MIGLOP</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="Register for MIGLOP POS System" name="keywords">
    <meta content="Create your MIGLOP account and start managing your business" name="description">
        ...
        <div class="row gx-0">
            <div class="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
                <div class="d-inline-flex align-items-center" style="height: 45px;">
                    ...
                    <small class="text-light"><i class="fa fa-envelope-open me-2"></i>info@MIGLOP.com</small>
                </div>
            </div>
    ...
    <div class="container-fluid position-relative p-0">
        <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
            <a href="{{ route('home') }}" class="navbar-brand p-0">
                <h1 class="m-0"><i class="fa fa-shopping-cart me-2"></i>MIGLOP</h1>
            </a>
            ...
            <div class="row g-5">
                <div class="col-lg-10 mx-auto">
                    <div class="section-title position-relative pb-3 mb-5 text-center">
                        ...
                        <h1 class="mb-0">Create Your MIGLOP Account</h1>
